...
const userStatsHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(status_code_1.StatusCode.RequestSuccessfull).json({ saveCount, impressionCount, profileViewCount: userData === null || userData === void 0 ? void 0 : userData.profileViews });
        return;
    }
    catch (err) {
