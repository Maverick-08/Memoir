...
const UserMessages = () => {
  return (
    <div className="min-h-screen sm:pt-[10vh] lg:pt-[10vh]  bg-gray-100">
      <div className="container mx-auto sm:h-[90vh] lg:h-[90vh] px-4">
        <div className="px-4 h-full lg:w-[70%] mx-auto bg-white shadow rounded-md">
